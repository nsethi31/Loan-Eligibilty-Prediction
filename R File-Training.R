Loan.Train <- read.csv("C:/Users/Nishit/Downloads/AV/Loan prediction 3/Loan-Train.csv")
View(Loan.Train)
attach(Loan.Train)
...
Training_Loan <- read.csv("C:/Users/Nishit/Downloads/AV/Loan prediction 3/Training_Loan.csv")
View(Training_Loan)
